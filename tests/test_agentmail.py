...
class TestEmailUtilsFallback:
    ...
    def test_send_email_falls_back_to_smtp(self):
        ...
        email_utils.EMAIL_ENABLED = True
        email_utils._transactional_inbox = None
        with patch("agentmail_client.ensure_inbox", return_value=None), \
        ...
        with patch.dict(os.environ, {
            ...
            with patch("database.init_db", return_value=True), \
                ...
                try:
                    ...
                    resp = client.post("/api/internal/send-email",
                                       json={"to": "a@b.com", "subject": "Hi", "text": "Hello"})
        ...
        with patch.dict(os.environ, {
            ...
            with patch("database.init_db", return_value=True), \
                ...
                try:
                    from app import app
                    client = app.test_client()
                    resp = client.post("/webhook/agentmail",
