    ...
    def test_no_bid_param_in_dashboard(self):
        ...
        for line in lines:
            if 'def dashboard(' in line:
                ...
                assert "request.args.get('bid'" not in line, \
                    "Dashboard still accepts building_id via query param"
    ...
    def test_meter_upload_no_body_building_id(self):
        ...
        for line in lines:
            if 'def api_meter_data_upload' in line:
                ...
                assert "data.get('building_id'" not in line, \
                    "Meter upload still reads building_id from request body"
