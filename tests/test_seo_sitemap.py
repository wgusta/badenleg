...
from tests.conftest import MOCK_PROFILES_LIST, MOCK_MUNICIPALITY_PROFILE
...
class TestSitemap:
    ...
    def test_profil_handles_missing_data(self, mock_db, full_client):
        mock_db.get_municipality_profile.return_value = {
            "bfs_number": 999, "name": "Testgemeinde", "kanton": "ZH",
            "population": None, "solar_potential_pct": None,
            "energy_transition_score": 0, "data_sources": {}
        }
